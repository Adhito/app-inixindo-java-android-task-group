...
public class HttpHandler {
    ...
    public String sendGetRespCoupon(String responseUrl, String detail_user, String search) {
        StringBuilder sb = new StringBuilder();
        try {
            Uri.Builder builder = new Uri.Builder();
            builder.appendQueryParameter("id_detail_user", detail_user).
                    appendQueryParameter("search_txt", search);
            URL url = new URL(responseUrl + builder);
            Log.d("url:", String.valueOf(builder));
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            BufferedReader reader = new BufferedReader(
